...
def clean_json():
    ...
    with open("reports/raw_phi3_json.txt", "r", encoding="utf-8") as f:
        report = f.read()
    ...
    with open("reports/cleaned_phi3_json.txt", "w", encoding="utf-8") as f:
        f.write(report)
    ...
    # Save valid JSON
    with open("reports/threat_score.json", "w", encoding="utf-8") as f:
